...
```
if we use `if` instead of `my-if-bad`, `factorial-wrong` acts just like we want. But with `my-if-bad`, the function never stops because 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2ODE5Mzk5NiwtMjAzNzQ2NzE1OSw1Mz
