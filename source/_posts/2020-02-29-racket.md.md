...
Racket uses the environment **before** the let-expression to evaluate `e1 e2 ... en`, which means if `en` uses `x1`, that would mean some outer variables of the same name. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4OTc5OTg1NTUsNTQ4MDQ0MzM5LC0xND
