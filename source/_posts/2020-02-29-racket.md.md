...
In most programming languages, given `e1 e2 ... en`, the function arguments `e2, ..., en` are evaluated once before the function body is executed. And 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzOTUxMzc2MywtMjAzNzQ2NzE1OSw1Mz
